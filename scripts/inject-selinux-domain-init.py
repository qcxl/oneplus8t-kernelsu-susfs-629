...
def fix_rules(kernel_root):
    ...
    new = (
        ...
        '    printk(KERN_ERR "KSU_DIAG: pol_pdb=%px ss_pdb=%px same=%d orig_len=%zu jiffies=%lu\\n",\n'
        '        &selinux_state.policy->policydb, &selinux_state.ss->policydb,\n'
        '        &selinux_state.policy->policydb == (void*)&selinux_state.ss->policydb,\n'
        '        selinux_state.policy->policydb.len, jiffies);\n'
