...
def fix_selinux_load_policy_kprobe(kernel_root):
    ...
    kprobe_code = (
        ...
        '\t\t "KSU_DIAG: secpol pre #%d jiffies=%lu\\n",\n'
        '\t\t call_no, jiffies);\n'
        '\tksu_diag_log(buf);\n'
        '\treturn 0;\n'
        '}\n'
        '\n'
        'static void ksu_security_load_policy_post(struct kprobe *p,\n'
        '\t\t\t\t     struct pt_regs *regs,\n'
        '\t\t\t\t     unsigned long flags)\n'
        '{\n'
        '\tstatic int call_no = 0;\n'
        ...
        '\tcall_no++;\n'
        '\tsnprintf(buf, sizeof(buf),\n'
        '\t\t "KSU_DIAG: secpol post #%d len=%zu jiffies=%lu\\n",\n'
        ...
        '}\n'
        '\n'
        'static struct kprobe ksu_security_load_policy_kp = {\n'
        '\t.symbol_name = "security_load_policy",\n'
        '\t.pre_handler = ksu_security_load_policy_pre,\n'
        '\t.post_handler = ksu_security_load_policy_post,\n'
        '};\n'
        '\n'
        'static int __init ksu_security_load_policy_kprobe_init(void)\n'
        '{\n'
        '\tint rc = register_kprobe(&ksu_security_load_policy_kp);\n'
        '\tif (rc) {\n'
        ...
        '\treturn 0;\n'
        '}\n'
        'late_initcall(ksu_security_load_policy_kprobe_init);\n'
    )
