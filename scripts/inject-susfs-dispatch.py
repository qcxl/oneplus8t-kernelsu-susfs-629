...
def add_susfs_handlers_to_dispatch(kernel_root):
    ...
    handler_code = (
        '\n'
        '/* SUSFS ioctl command (always defined for dispatch table entry) */\n'
        ...
        '\tif (copy_to_user(buf + pos, "CONFIG_KSU_SUSFS_SPOOF_CMDLINE_OR_BOOTCONFIG\\n", 45)) { zero = -EFAULT; goto features_err; }\n'
        '\tpos += 45;\n'
        '#endif\n'
        '#ifdef CONFIG_KSU_SUSFS_OPEN_REDIRECT\n'
        '\tif (copy_to_user(buf + pos, "CONFIG_KSU_SUSFS_OPEN_REDIRECT\\n", 31)) { zero = -EFAULT; goto features_err; }\n'
        '\tpos += 31;\n'
        '#endif\n'
        '#ifdef CONFIG_KSU_SUSFS_SUS_MAP\n'
        '\tif (copy_to_user(buf + pos, "CONFIG_KSU_SUSFS_SUS_MAP\\n", 25)) { zero = -EFAULT; goto features_err; }\n'
        '\tpos += 25;\n'
        '#endif\n'
        '#ifdef CONFIG_KSU_SUSFS_ENABLE_AVC_LOG_SPOOFING\n'
        '\tif (copy_to_user(buf + pos, "CONFIG_KSU_SUSFS_ENABLE_AVC_LOG_SPOOFING\\n", 41)) { zero = -EFAULT; goto features_err; }\n'
        '\tpos += 41;\n'
        '#endif\n'
        '#ifdef CONFIG_KSU_SUSFS_SUS_PATH_LOOP\n'
        '\tif (copy_to_user(buf + pos, "CONFIG_KSU_SUSFS_SUS_PATH_LOOP\\n", 31)) { zero = -EFAULT; goto features_err; }\n'
        '\tpos += 31;\n'
        '#endif\n'
        '#ifdef CONFIG_KSU_SUSFS_SUS_OVERLAYFS\n'
        '\tif (copy_to_user(buf + pos, "CONFIG_KSU_SUSFS_SUS_OVERLAYFS\\n", 31)) { zero = -EFAULT; goto features_err; }\n'
        '\tpos += 31;\n'
        '#endif\n'
        '#ifdef CONFIG_KSU_SUSFS_AUTO_ADD_SUS_BIND_MOUNT\n'
        '\tif (copy_to_user(buf + pos, "CONFIG_KSU_SUSFS_AUTO_ADD_SUS_BIND_MOUNT\\n", 41)) { zero = -EFAULT; goto features_err; }\n'
        '\tpos += 41;\n'
        '#endif\n'
        '#ifdef CONFIG_KSU_SUSFS_AUTO_ADD_SUS_KSU_DEFAULT_MOUNT\n'
        '\tif (copy_to_user(buf + pos, "CONFIG_KSU_SUSFS_AUTO_ADD_SUS_KSU_DEFAULT_MOUNT\\n", 48)) { zero = -EFAULT; goto features_err; }\n'
        '\tpos += 48;\n'
        '#endif\n'
        '#ifdef CONFIG_KSU_SUSFS_AUTO_ADD_TRY_UMOUNT_FOR_BIND_MOUNT\n'
        '\tif (copy_to_user(buf + pos, "CONFIG_KSU_SUSFS_AUTO_ADD_TRY_UMOUNT_FOR_BIND_MOUNT\\n", 52)) { zero = -EFAULT; goto features_err; }\n'
        '\tpos += 52;\n'
        '#endif\n'
...
'\tcase CMD_SUSFS_ENABLE_LOG:\n'
	...
	'\tcase CMD_SUSFS_SHOW_VERSION: {\n'
         ...
         '\t\treturn susfs_show_features(uarg);\n'
	'\tcase CMD_SUSFS_ENABLE_AVC_LOG_SPOOFING:\n'
         ...
         '\t\treturn 0;\n'
          ...
          '\tcase CMD_SUSFS_IS_BOOT_RESTORED:\n'
          '\t\treturn susfs_is_boot_restored();\n'
          '\tdefault:\n'
          '\t\treturn -EINVAL;\n'
         '\t}\n'
         '}\n'
...
def add_susfs_reboot_handler(kernel_root):
	...
	'\t\tpr_debug("susfs: reboot cmd=0x%x\\n", cmd);\n'
        '\t\tswitch (cmd) {\n'
        '\t\tcase CMD_SUSFS_ADD_SUS_PATH:\n'
        '\t\t\treturn susfs_add_sus_path((struct st_susfs_sus_path __user *)uarg);\n'
        '\t\tcase CMD_SUSFS_ADD_SUS_MOUNT:\n'
