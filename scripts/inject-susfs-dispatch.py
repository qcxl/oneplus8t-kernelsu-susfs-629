...
'\tcase CMD_SUSFS_ENABLE_LOG:\n'
	...
	'\tcase CMD_SUSFS_ENABLE_AVC_LOG_SPOOFING:\n'
         ...
         '\t\treturn susfs_add_sus_kstat_statically((struct st_susfs_sus_kstat __user *)uarg);\n'
