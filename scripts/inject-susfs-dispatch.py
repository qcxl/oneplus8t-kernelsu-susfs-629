...
def add_susfs_handlers_to_dispatch(kernel_root):
	...
	'\tcase CMD_SUSFS_SHOW_VERSION: {\n'
         '\t\tint zero = 0;\n'
         '\t\tif (copy_to_user(uarg, SUSFS_VERSION, min(strlen(SUSFS_VERSION)+1, 16u)))\n'
         ...
         '\t\tint zero = 0;\n'
         '\t\tif (copy_to_user(uarg, SUSFS_VARIANT, min(strlen(SUSFS_VARIANT)+1, 16u)))\n'
         ...
         '\t\t\tpr_err("susfs: copy_to_user features failed\\n");\n'
