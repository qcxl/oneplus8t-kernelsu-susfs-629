...
def inject_susfs_c():
    ...
    path_loop_infra = (
        ...
        '};\n'
        '\n'
        '/* local copy of sus_path_list struct (for gitlab v1.5.5 compatibility) */\n'
        'struct st_susfs_sus_path_list_local_local {\n'
        ...
        '\tstruct st_susfs_sus_path_list_local *new_list = NULL;\n'
        '\n'
        ...
        '\t}\n'
        '\n'
        '\tnew_list = kzalloc(sizeof(struct st_susfs_sus_path_list_local), GFP_KERNEL);\n'
        '\tif (!new_list) {\n'
        '\t\tinfo.err = -ENOMEM;\n'
        '\t\tgoto out;\n'
        '\t}\n'
        ...
        '\tstruct st_susfs_sus_path_list_local *cursor = NULL;\n'
        '\tstruct path path;\n'
        '\tstruct inode *inode;\n'
        '\n'
