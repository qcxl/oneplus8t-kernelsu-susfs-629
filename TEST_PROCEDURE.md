...
- [ ] ERRORS.md：新项目建议保留跨项目通用的经验（E005 文件版本差异、E006 可行性调研等），删除项目特定的条目（如 E001-E004、E007-E009 SUSFS 特有问题）
- [ ] commit message 格式：`feat: 项目名-版本 移植 - 功能说明`（第 I 部分第5节的格式是通用的，无需修改）
